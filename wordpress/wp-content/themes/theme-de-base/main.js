import { S as o, A as u, g as s } from "./vendor.d01bfbfa.js";
const c = function () {
...
c();
o.use([u]);
let p = document.querySelector(".menu__toggle a"),
  r = document.querySelector(".hamburger");
p.addEventListener("click", () => {
  (r.style.display = "block"),
    r.classList.toggle("open"),
    r.classList.contains("open") || (r.style.display = "none");
});
let a = document.querySelector(".Nav");
document.querySelector(".logo img");
window.onscroll = () => {
  (document.body.scrollTop >= 100) | (document.documentElement.scrollTop >= 100)
    ? (a.classList.add("colored"), a.classList.remove("transparent"))
    : (a.classList.add("transparent"), a.classList.remove("colored"));
};
s.fromTo(
  ".terre",
  { rotate: 0 },
...
var y = document.getElementById("myModal"),
  m = document.getElementById("myInput");
y.addEventListener("shown.bs.modal", function () {
  m.focus();
});
